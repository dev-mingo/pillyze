...
/// Copied from Flutter's original `[PageView]` implementation.
...
class AppCachedPageView extends StatefulWidget {
  ...
  ///
  /// {@macro flutter.widgets.PageView.allowImplicitScrolling}
  const AppCachedPageView.custom({
    super.key,
    this.scrollDirection = Axis.horizontal,
    this.reverse = false,
    required this.controller,
  ...
  @override
  State<AppCachedPageView> createState() => _AppCachedPageViewState();
}

class _AppCachedPageViewState extends State<AppCachedPageView> {
  final PageScrollPhysics _pageScrollPhysics = const PageScrollPhysics();
  ...
  Widget build(BuildContext context) {
    ...
    final ScrollPhysics physics = _ForceImplicitScrollPhysics(
      ...
      widget.pageSnapping
          ? _pageScrollPhysics.applyTo(widget.physics ??
